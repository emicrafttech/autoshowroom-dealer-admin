...
export function buildVehiclePayload(form: VehicleDraftForm) {
  return {
    ...
    registrationState: form.registrationState || undefined,
    registrationLga: form.registrationLga || undefined,
    customsDutyStatus: form.customsDutyStatus,
    customsReference: form.customsReference || undefined,
    bodyHistory: form.bodyHistory,
    papersStatus: form.papersStatus,
    dutyPaidClaim: form.dutyPaidClaim,
    listingTrust: form.listingTrust || undefined,
